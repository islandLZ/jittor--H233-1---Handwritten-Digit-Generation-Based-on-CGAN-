...
for epoch in range(opt.n_epochs):
    ...
    if epoch % 10 == 0:
        generator.save("./weights/generator_last.pkl")
        discriminator.save("./weights/discriminator_last.pkl")

generator.eval()
discriminator.eval()
generator.load('./weights/generator_last.pkl')
discriminator.load('./weights/discriminator_last.pkl')

number = '830085829737'#TODO: 写入比赛页面中指定的数字序列（字符串类型）
n_row = len(number)
